...
# Словарь для преобразования падежа даты в стандартный вид
MONTH_DECLENSIONS = {'января': 'январь', 'февраля': 'февраль', 'марта': 'март', 'апреля': 'апрель',
                     'мая': 'май', 'июня': 'июнь', 'июля': 'июля', 'августа': 'август', 'сентября': 'сентябрь',
